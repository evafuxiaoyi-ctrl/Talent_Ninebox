...
def _make_split_workbook(path) -> None:
    ...
    sheet.append(["员工姓名", "工号", "邮箱", "岗位", "一级部门", "二级部门", "备注公式"])
    sheet.append(["张三", "001", "a@example.com", "顾问", "销售部", "华东", '=A4&"-"&E4'])
    sheet.append(["李四", "002", "b@example.com", "主管", "教研部", "数学", '=A5&"-"&E5'])
    sheet.append(["王五", "003", "c@example.com", "顾问", "销售部", "华南", '=A6&"-"&E6'])
